	...
	<div class="col-md-12">
							...
							if (isset($_POST['simpan'])) {
								...
								if ($sisa <= 0) {
									...
									$sql = $koneksi->query("insert into tb_transaksi(judul, nis, nama, tanggal_pinjam, tanggal_kembali, status) values('$judul','$nis','$nama','$tanggal_pinjam','$tanggal_kembali','Pinjam')");
